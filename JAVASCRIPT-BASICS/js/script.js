...
date();
/**   * celciusToFarenheit function find the farenheit value
          * @param {celcius} type number.
          * @return  type number*/
...
let array=[3,4,5,6,7];
let average=0;
/**   * avg function find the average from array of number
          * @param {array}.
          * @return  type number*/
function avg(param) {
    let sum=0;
